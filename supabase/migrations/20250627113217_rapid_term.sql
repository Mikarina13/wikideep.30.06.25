...
-- Add constraints using DO blocks to avoid syntax errors
DO $$
BEGIN
  IF NOT EXISTS (
...
-- Users policies (drop first, then create)
...
-- Archive posts policies (drop first, then create)
...
-- Collab posts policies (drop first, then create)
...
-- Forum posts policies (drop first, then create)
...
-- User favorites policies (drop first, then create)
...
-- Create triggers (drop first, then create)
